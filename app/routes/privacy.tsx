export default function Privacy() {
  return (
    <>
      ...
      <p>
        Your privacy is important to us. It is Get Focused&#39;s policy to
        ...
        across our website,{' '}
        <a href="https://getfocused.royanger.app">
          https://getfocused.royanger.app
        </a>
        , and other sites we own and operate.{' '}
      </p>
      <p>
        This policy is effective as of 8 May 2022 and was last updated on 8 May
        2022.{' '}
      </p>
      ...
      <p>
        Roy Anger
        <br />
        https://getfocused.royanger.app/contact{' '}
      </p>
    </>
  )
}
